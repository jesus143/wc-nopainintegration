...
class WC_Allpay_Aio_Cvs extends GW_Allpay_Aio 
{
	public function __construct() 
	{
		parent::__construct();			
		$this->id = 'allpay_aio_cvs';
		$this->icon = apply_filters( 'wc_allpay_aio_cvs_icon', '' );		
		$this->method_title = __('超商代碼繳費', 'woocommerce');
	...
	public function get_allpay_args( $order ) 
	{
		...
		$allpay_args =array(
			...
			'ExpireDate' => $this->settings['cvs_expire_date'] * 1440,			
			...
			'StoreExpireDate' => $this->settings['cvs_expire_date'] * 1440,		
		...
		$allpay_args['CheckMacValue'] = $this->create_check_code( $allpay_args );
	    	...
	    	$allpay_args = apply_filters('woocommerce_allpay_aio_cvs_args', $allpay_args);
