...
class WC_Allpay_Aio_Atm extends GW_Allpay_Aio 
{	
	public function __construct() 
	{
		parent::__construct();			
		$this->id = 'allpay_aio_atm';
		$this->icon = apply_filters( 'wc_allpay_aio_atm_icon', '' );		
		$this->method_title = __('ATM虛擬帳號', 'woocommerce');
	...
	public function get_allpay_args( $order ) 
	{
		...
		$allpay_args = array(
			...
			'ExpireDate' => $this->settings['atm_expire_date'],			
		...
		$allpay_args['CheckMacValue'] = $this->create_check_code( $allpay_args );
	    	...
	    	$allpay_args = apply_filters('woocommerce_allpay_aio_atm_args', $allpay_args);
