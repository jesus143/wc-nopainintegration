...
class WC_Allpay_Aio_Ibon extends GW_Allpay_Aio 
{
	public function __construct() 
	{
		parent::__construct();			
		$this->id = 'allpay_aio_ibon';
		$this->icon = apply_filters( 'wc_allpay_aio_ibon_icon', '' );		
		$this->method_title = __('7-ELEVEN ibon', 'woocommerce');
	...
	public function get_allpay_args( $order ) 
	{
		...
		$allpay_args =array(
			...
			'StoreExpireDate' => $this->settings['ibon_expire_date'],	
		...
		$allpay_args['CheckMacValue'] = $this->create_check_code( $allpay_args );
	    	...
	    	$allpay_args = apply_filters('woocommerce_allpay_aio_ibon_args', $allpay_args);
